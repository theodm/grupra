...
class ImageConverterTest {
    ...
    void testGross() throws IOException {
        ImageConverter.main(new String[]{"--input=./src/main/resources/KE1_TestBilder/test_gross.tga", "--output=test_gross.propra"});
        ImageConverter.main(new String[]{"--input=test_gross.propra", "--output=test_gross.tga"});
        checkEqualFiles("./src/main/resources/KE1_TestBilder/test_gross.tga", "test_gross.tga");
    }
